...
function showUser(){
    if(currentUser){
        ...
        document.getElementById("userDisplay").innerText =
            users[currentUser].role + " | " + currentUser;
    }
}
...
function renderTable() {
    ...
    `<button class="delete-btn" onclick="hapusItem('${nama}')">🗑</button>`;
    }
...
function generateStruk(uang, kembali, dataKeranjang, metode = "CASH") {
    ...
    document.getElementById("strukKasir").innerText =
    "Kasir : " + (currentUser ? currentUser : "-");
